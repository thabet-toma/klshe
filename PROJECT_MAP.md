...
- M3: توحيد رسائل الخطأ، وسم SQL المضلّل، ربط i18n الفعلي، العملة/التاريخ، إزالة كود ميت
- M4: allowlist سائقين، إعادة تصميم لوحات، رحلة زبون احترافية، اعتماد+تسوية+إشعارات، اختبارات+CI
